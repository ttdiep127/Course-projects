    ...
    <div id="content">
      <div id="content_left">
        <div class="content_left_section_01">
          ...
          <p>
            <strong>${result_friends}</strong>
          </p>
        <div class="content_left_section_02">
        <div class="latest_profile_title">Bạn bè .</div>
        ...
        <div class="latest_profile_box_list"> <img src="${pageContext.request.contextPath}/images/avatar_man.jpg" alt=""></div>
          <div class="name">${friend.getFull_name()}</div>
          <c:set  var = "on_off" value="${friend.getOn_off()}"/>
            	<c:choose>
          ...
          <div class="readmore"><a href="${pageContext.request.contextPath}/ViewInfoUser?search_user_name=${friend.getFull_name()}&&view_info_me=false">Details &raquo;</a></div>
        </c:forEach>
        </div>
