...
<body>
  <div id="templatmeo_quick_search">
    ...
    <div class="form_container">
      <form action="${pageContext.request.contextPath}/SearchUserOther" method="post">
        <fieldset>
          ...
          <div class="search_row">
            ...
            <div class="search_column_2">
              <select class="gender" title="year" name="min_Max">
              ...
              </select> <label class="seeking">Tới</label> <select class="gender"
                title="year" name="min_old">
                <option value="2017">2017</option>
                <option value="2016">2016</option>
                <option value="2015">2015</option>
                <option value="2014">2014</option>
                ...
                <option value="1906">1906</option>
                <option value="1905">1905</option>
              </select> <label class="seeking"></label>
            </div>
          </div>
          <div class="search_row">
            <div class="search_column_1">
